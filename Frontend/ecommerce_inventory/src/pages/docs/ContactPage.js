...
const ContactPage = () => {
  ...
  return (
    <>
      <Title
        title="Contactez-Nous | Niplan"
        description="Nous sommes là pour vous aider. Contactez-nous par téléphone, WhatsApp, email ou visitez notre bureau."
        keywords="contact, support, assistance, Niplan, e-commerce"
